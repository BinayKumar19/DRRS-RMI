...
public class DorvalServerImpl extends UnicastRemoteObject
    ...
    protected DorvalServerImpl() throws RemoteException {
		super();
    ...
    throws RemoteException
    {
		...
		String sStatus;
        try {
            FileWriter file = new FileWriter("./Logs/DorvalServer.txt",true); 
    ...
    //   hRoom.remove(date);
	 ...
	 public String bookRoomDorval (String sStudentId,Integer roomNumber,String date,String timeslot) 
	    { String sBookingId;
    ...
    throws RemoteException
    { String sBookingStatus = "Not Booked";
    ...
    if (campusName.equals("Dorval"))
    	  {sBookingStatus = bookRoomDorval(sStudentId,roomNumber,date,timeslot);}
    
      else if (campusName.equals("Kirkland")||campusName.equals("Westmount"))
   ...
   return sBookingStatus;
    ...
    public String getAvailableTimeSlotDorval(String date)
    throws RemoteException
     { String sBookingStatus="Dorval:";
    ...
    public String getAvailableTimeSlot(String sServer, String date)
	    throws RemoteException
	{  String sTimeSlotCount = getAvailableTimeSlotDorval(date);
       
	   if (sServer.equals("Dorval"))   	
       {try
       {
           DatagramSocket clientSocket = new DatagramSocket();
           InetAddress IPAddress = InetAddress.getByName("localhost");
	...
	public String cancelBookingDorval(String sBookingID)
	{ BufferedWriter output = null;
	  DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	  Date d1 = new Date();
  ...
  public String cancelBooking(String sStudentId,String sBookingID)
    ...
    { String sBookingStatus="Wrong Booking ID";
        ...
        if (sBookingID.charAt(0)=='D')
         { sBookingStatus = cancelBookingDorval(sStudentId+sBookingID);
         }
        else if (sBookingID.charAt(0)=='W'||sBookingID.charAt(0)=='K')
         {
          try {    	  	
          DatagramSocket clientSocket = new DatagramSocket();
          InetAddress IPAddress = InetAddress.getByName("localhost");
